...
print(ee.Array([2, -2, 3, 1]).accum(0, ee.Reducer.sum()).getInfo())  # [2, 0, 3, 4]

# Some example reducers.
print(ee.Array([2, -2, 3, 1]).accum(0, ee.Reducer.max()).getInfo())  # [2, 2, 3, 3]
print(ee.Array([2, -2, 3, 1]).accum(0, ee.Reducer.mean()).getInfo())  # [2, 0, 1, 1]
print(ee.Array([2, -2, 3, 1]).accum(0, ee.Reducer.min()).getInfo())  # [2, -2, -2, -2]
print(ee.Array([2, -2, 3]).accum(0, ee.Reducer.product()).getInfo())  # [2, -4, -12]
